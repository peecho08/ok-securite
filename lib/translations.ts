const fr: Record<string, string | string[]> = {
  ...
  // ── Plans / pricing ─────────────────────────────────────
  "plans.title": "Gratuit pendant le lancement",
  "plans.subtitle": "Toutes les fonctionnalités sont incluses — sans frais — pendant notre période d'accès anticipé.",
  "plans.earlyAccess": "Accès anticipé",
  "plans.earlyAccessBadge": "Maintenant",
  "plans.free": "Accès anticipé",
  "plans.silver": "Argent",
  "plans.gold": "Or",
  "plans.free.price": "0 $",
  "plans.silver.price": "À venir",
  "plans.gold.price": "À venir",
  "plans.free.desc": "Toutes les fonctionnalités incluses pendant le lancement",
  "plans.silver.desc": "Pour les petites équipes",
  "plans.gold.desc": "Pour les entreprises",
  "plans.popular": "Maintenant",
  "plans.comingSoon": "Bientôt",
  "plans.cta.free": "Commencer gratuitement",
  "plans.cta.silver": "Être notifié",
  "plans.cta.gold": "Être notifié",
  ...
  "plans.yes": "Oui",
  "plans.launchNote": "Les forfaits payants seront disponibles prochainement. Profitez de tout, gratuitement, en tant que premier utilisateur.",
...
const en: Record<string, string | string[]> = {
  ...
  // ── Plans / pricing ─────────────────────────────────────
  "plans.title": "Free during launch",
  "plans.subtitle": "All features included — at no cost — during our early access period.",
  "plans.earlyAccess": "Early access",
  "plans.earlyAccessBadge": "Now",
  "plans.free": "Early Access",
  "plans.silver": "Silver",
  "plans.gold": "Gold",
  "plans.free.price": "$0",
  "plans.silver.price": "Coming soon",
  "plans.gold.price": "Coming soon",
  "plans.free.desc": "All features included during launch",
  "plans.silver.desc": "For small teams",
  "plans.gold.desc": "For companies",
  "plans.popular": "Now",
  "plans.comingSoon": "Soon",
  "plans.cta.free": "Get started for free",
  "plans.cta.silver": "Get notified",
  "plans.cta.gold": "Get notified",
  ...
  "plans.feat.branding.silver": "—",
  "plans.yes": "Yes",
  "plans.launchNote": "Paid plans coming soon. Enjoy everything, for free, as an early user.",
