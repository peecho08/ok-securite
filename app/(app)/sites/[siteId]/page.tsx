    ...
    return (
      <div className="flex min-h-dvh flex-col dark:bg-neutral-900">
        <header className="bg-[var(--color-header)] px-5 pt-[calc(env(safe-area-inset-top)+1.5rem)] pb-5 sm:px-8">
          <Link href="/my-sites" className="inline-flex items-center gap-2 text-sm text-white/80">
    ...
    <div className="flex min-h-dvh flex-col dark:bg-neutral-900">
      ...
      <header className="bg-[var(--color-header)] px-5 pt-[calc(env(safe-area-inset-top)+1.5rem)] pb-5 sm:px-8">
        <div className="flex items-center justify-between">
          <Link href="/my-sites" className="inline-flex items-center gap-2 text-sm text-white/80 transition-colors active:text-white">
            <ArrowLeft className="h-4 w-4" />
            {t("nav.back")}
          </Link>
          {!showDeleteConfirm ? (
