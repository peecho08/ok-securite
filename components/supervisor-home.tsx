    ...
    <div className="flex min-h-dvh flex-col dark:bg-neutral-900">
      ...
      <header className="bg-[var(--color-header)] px-5 pt-[calc(env(safe-area-inset-top)+1.5rem)] pb-5 sm:px-8">
        ...
        <div className="mt-0.5 flex items-center gap-2">
          ...
          {!planLoading && (
            <span className={`inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-bold uppercase tracking-wide ${
              plan === "gold" ? "bg-amber-400/30 text-amber-100 ring-1 ring-amber-400/40" :
              plan === "silver" ? "bg-blue-400/30 text-blue-100 ring-1 ring-blue-400/40" :
              "bg-white/15 text-white/70"
            }`}>
              {plan === "gold" && <span className="text-[10px]">★</span>}
              ...
              <div className="flex items-center gap-2">
                ...
                {!planLoading && (
                  <span className={`inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-[11px] font-bold uppercase tracking-wide ${
                    plan === "gold" ? "bg-amber-100 text-amber-700 ring-1 ring-amber-200 dark:bg-amber-900/40 dark:text-amber-300 dark:ring-amber-700/50" :
                    plan === "silver" ? "bg-blue-100 text-blue-700 ring-1 ring-blue-200 dark:bg-blue-900/40 dark:text-blue-300 dark:ring-blue-700/50" :
